...
J'utilise [FastApi](https://fastapi.tiangolo.com/) + [Playwright](https://playwright.dev/python/) pour faire le service mais vous pouvez utiliser ce que vous voulez.
...
J'utilise [Poetry](https://python-poetry.org/) pour gérer les dépendances et surtout pour générer le fichier de requirements
...
si je vais sur [https://test-nuxt3-faas.flapili.fr/_api/capture](https://test-nuxt3-faas.flapili.fr/_api/capture) j'ai ça comme rendu :

![capture](/posts/nuxt3-capture/capture.jpeg)

Et si je partage le lien sur discord TADAAAA !

![previsu-discord](/posts/nuxt3-capture/previsu-discord.jpeg)
